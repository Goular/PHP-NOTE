...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="index_body">
        <div class="block clearfix" style="position: relative; height: 98px;">
            <a href="#" name="top"><img class="logo" src="/Application/Home/Public/images/logo.gif"></a>
        ...
        <div class="header_bg">
            ...
            <form id="searchForm" method="get" action="#">
                ...
                <input name="imageField" value=" " class="go" style="cursor: pointer; background: url('/Application/Home/Public/images/sousuo.gif') no-repeat scroll 0% 0% transparent; width: 39px; height: 20px; border: medium none; float: left; margin-right: 15px; vertical-align: middle;" type="submit" />
        ...
        <div class="header_bg_b">
            <div class="f_l" style="padding-left: 10px;">
                <img src="/Application/Home/Public/images/biao6.gif" />
                北京市区，现在下单(截至次日00:30已出库)，<b>明天上午(9-14点)</b>送达 <b>免运费火热进行中！</b>

            </div>
            <div class="f_r" style="padding-right: 10px;">
                <img style="vertical-align: middle;" src="/Application/Home/Public/images/biao3.gif">
                    <span class="cart" id="ECS_CARTINFO">
                        <a href="#" title="查看购物车">您的购物车中有 0 件商品，总计金额 ￥0.00元。</a></span>
                    <a href="#"><img style="vertical-align: middle;" src="/Application/Home/Public/images/biao7.gif"></a>
            ...
            <div class="block box">
                ...
                <div class="usBox">
                    <div class="usBox_2 clearfix">
                        ...
                        <form id="yw0" action="/home/user/register" method="post">                <table cellpadding="5" cellspacing="3" style="text-align:left; width:100%; border:0;">
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width:87%;">
                                            ...
                                            <span style="color:red;"><?php echo !empty($errorinfo["username"])?$errorinfo["username"]:''; ?></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
        ...
        <div class="blank"></div>
        <div class="block">
            <a href="#" target="_blank" title="YONGDA商城"><img alt="YONGDA商城" src="/Application/Home/Public/images/di.jpg"></a>
            <div class="blank"></div>
        </div>
        ...
        <div id="bottomNav" class="box block">
            <div class="box_1">
                <div class="links clearfix"> 
                    <a href="#" target="_blank" title="YONGDA商城"><img src="/Application/Home/Public/images/ecmoban_link.jpg" alt="YONGDA商城" border="0"></a>

                    <a href="#" target="_blank" title="YONGDA 网上商店管理系统">
                        <img src="/Application/Home/Public/images/yongda_logo.gif" alt="YONGDA 网上商店管理系统" border="0" />
                    </a>
